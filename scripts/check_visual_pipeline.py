...
trajectory=Trajectory(np.array([0.,1.]),np.repeat(start[None],2,axis=0),{"family":"reach","source":"synthetic"})
scenario={"marker_id":7,"marker_size_m":.16,"marker_to_goal":[0,0,0],"marker_rpy_rad":[0,-np.pi/2,0],
